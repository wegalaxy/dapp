...
export const GAME_ABI = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "decimalPoints", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "id", type: "uint256" },
      { internalType: "string", name: "name", type: "string" },
      { internalType: "string", name: "currencyPair", type: "string" },
